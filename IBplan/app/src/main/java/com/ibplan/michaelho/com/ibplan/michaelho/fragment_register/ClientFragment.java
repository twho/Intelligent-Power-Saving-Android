...
public class ClientFragment extends Fragment implements GCMConfig{
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (AccountCheck(nameToReg.getText().toString(), emailToReg.getText().toString(), mac) && gcmCheck(regId)) {
                    new TaskAddMember().execute(nameToReg.getText().toString(), emailToReg.getText().toString(), mac, regId, photoPath);
                } else {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_IMAGE) {
                ...
                try {
                    ...
                    photoPath = iu.getPath(getActivity(), uri);
    ...
    private void setPortrait(Bitmap bmp, Uri uri) {
        personalImg.setImageBitmap(bmp);
    }
