 ...
 */
public class sqlOpenHelper_labDetails extends SQLiteOpenHelper implements BuildingConstants {
    public static final String DBNAME = "labdetaildb.sqlite";
    public static final int VERSION = 1;
    public static final String TABLENAME = "lab_details";
    public static final String ID = "Id";
    public static final String NAME = "Name";
    public static final String IMG = "Image";
    public static final String DETAIL = "Detail";

    public sqlOpenHelper_labDetails(Context context) {
    ...
    public ArrayList<HashMap<String, Object>>  getAllLabDetail() {
        SQLiteDatabase db = getReadableDatabase();
