...
public interface URLConstants {
    ...
    public static final String URL_GET_LAB_DETAIl = SERVER_IP
            + IBUILDINGS_FOLDER + "get_lab_detail.php";
    ...
    public static final String URL_GET_LAB_STATS= SERVER_IP
            + IBUILDINGS_FOLDER + "get_lab_stats.php";
}
